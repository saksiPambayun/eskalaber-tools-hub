...
@section('title', 'Add Toolsman')
@section('page-title', 'Tambah Toolsman')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Form Tambah Toolsman</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.toolsmans.create') }}" method="POST">
                        @csrf
