...
@section('page-title', 'Tambah Tool')
    ...
    <div class="col-md-10">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Form Tambah Tool</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.tools.create') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="name" class="form-label">Nama Tool <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="code" class="form-label">Kode Tool <span class="text-danger">*</span></label>
